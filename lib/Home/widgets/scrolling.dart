...
class HorizontalItemList extends StatelessWidget {
  ...
  Widget _buildItemCard(BuildContext context, Donation item) {
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 4),
              Text(item.price != null && item.price! > 0 ? '£${item.price!.toStringAsFixed(2)}' : 'FREE', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w900, color: Colors.teal)),
            ]),
          ),
        ]),
      ),
  ...
  Widget _imageFallback() => Container(height: 100, color: Colors.grey[200], child: const Center(child: Icon(Icons.photo_library, color: Colors.grey)));
}
